...
public class MethodInvocationTest {
	...
	public void testGetObject() throws Exception {
		...
		assertThat(((MethodTestTarget) inv.getInvoker()).getValue(), is("Hello"));
	}
	...
	public void testGetObject_Null() throws Exception {
		MethodTestTarget obj = new MethodTestTarget();
		obj.setValue("Hello");
		MethodInvocation inv = new MethodInvocation(factory, factory, null, of("Hello"));
	...
	public void testProceed_Static() throws Exception {
		MethodInvocation inv = new MethodInvocation(factory, factory, null, of("static"));
		Object result = inv.proceed();
		assertThat(result, is(MethodTestTarget.class));
		assertThat(((MethodTestTarget) result).getValue(), is("static"));
	}
